...
typedef struct
{
    int last_block;         // id of last block in disk
    int records_per_block;  // maximum records that can be stored in a block
    int last_block_records; // how many records there are in the last block currently
